...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE espanhol SET titulo='$titulo', subtitulo='$subtitulo', conteudo='$conteudo' WHERE id=$id";
...
<body>
    <h1>Editar Post</h1>
    <form action="editar_espanhol.php" method="post">
...
<?php
    if(isset($_POST["salvar"])){
        header("location: ../htmls/espanhol.php");
    }
?>