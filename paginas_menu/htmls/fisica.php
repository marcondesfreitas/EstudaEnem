...
<body>
      ...
      <ul>
        <?php
          if($user == 'false'){
            ...
            <fieldset id='meuMenu'>
                <form action='../add/fisica.php' enctype='multipart/form-data' method='POST'>
            ...
            <div class='adms'>
              ...
              <fieldset id='menu1'>
                <form method='post' action='./mudarconteudo/mudar_fisica.php'>
  ...
  <?php include '../PHP/fisica_post.php'; ?>
