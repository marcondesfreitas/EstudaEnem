...
<head>
  ...
  <link rel="stylesheet" href="../css/espanhol.css">
...
<body>
      ...
      <ul>
        <?php
          if($user == 'false'){
            ...
            <fieldset id='meuMenu'>
                <form action='../add/espanhol.php' enctype='multipart/form-data' method='POST'>
            ...
            <div class='adms'>
              ...
              <fieldset id='menu1'>
                <form method='post' action='./mudarconteudo/mudar_espanhol.php'>
  ...
  <?php include '../PHP/espanhol_post.php'; ?>
