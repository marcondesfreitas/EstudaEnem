...
<body>
      ...
      <ul>
        <?php
          if($user == 'false'){
            ...
            <fieldset id='meuMenu'>
                <form action='../add/biologia.php' enctype='multipart/form-data' method='POST'>
            ...
            <div class='adms'>
              ...
              <fieldset id='menu1'>
                <form method='post' action='./mudarconteudo/mudar_biologia.php'>
  ...
  <?php include '../PHP/biologia_post.php'; ?>
