...
<body>
      ...
      <ul>
        <?php
          if($user == 'false'){
            ...
            <fieldset id='meuMenu'>
                <form action='../add/ingles.php' enctype='multipart/form-data' method='POST'>
            ...
            <div class='adms'>
              ...
              <fieldset id='menu1'>
                <form method='post' action='./mudarconteudo/mudar_ingles.php'>
  ...
  <?php include '../PHP/ingles_post.php'; ?>
