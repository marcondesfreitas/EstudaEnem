...
<head>
  ...
  <link rel="stylesheet" href="../css/portugues.css">
...
<body>
      ...
      <ul>
        <?php
          if($user == 'false'){
            ...
            <fieldset id='meuMenu'>
                <form action='../add/portugues.php' enctype='multipart/form-data' method='POST'>
            ...
            <div class='adms'>
              ...
              <fieldset id='menu1'>
                <form method='post' action='./mudarconteudo/mudar_portugues.php'>
  ...
  <?php include '../PHP/portugues_post.php'; ?>
